{{-- <div class="w-full fixed z-[1000] left-0 bottom-0 flex justify-center">
    <div class="w-[600px] md:w-[500px] flex justify-around py-2 bg-slate-50 border-t-2 w-full">
        <a href="#" class="{{url()->current() == route('login') ? "text-yellow-500 font-bold" : ""}} font-poppins hover:text-yellow-500 hover:font-bold flex flex-col justify-center items-center">
        ...
        <a href="#" class="{{url()->current() == route('login') ? "text-yellow-500 font-bold" : ""}} font-poppins hover:text-yellow-500 flex flex-col justify-center items-center">
        ...
        <a href="#" class="relative {{url()->current() == route('login') ? "text-yellow-500 font-bold" : ""}} font-poppins hover:text-yellow-500 flex flex-col justify-center items-center">
            <p id="counterNotif" class="text-xl font-bold text-red-500 absolute right-3 bottom-7">0</p>
